...
<body>
	...
	<div class="mainContainer">
		<div class="sidenav" style="position: fix;">
			...
			<form action="com" id="goDeptForm">
				<input type="hidden" name="command" value="dept"> <a
					href="#" id="goDeptA" style="color: black; background-color: #E7EFC5;"> Dept Info</a>
			</form>
		...
		<div class="content container">	<!-- dept & emp 데이터로 제공하는 목록들  -->
			<h2 style="margin-left: 10px; font-style: italic;">Department
				Profile</h2>

			<div class="card">
				<img src="../img/account.jpg" alt="Avatar" style="width: 100%">
				<h4> <b> 부서번호 : ${requestScope.one.deptno} <br> </b> </h4>
				<p> 부서명 : ${requestScope.one.dname} <br> </p> 
				<p> 부서위치 : ${requestScope.one.loc} <br> </p>
			</div>
		</div>
	</div>
